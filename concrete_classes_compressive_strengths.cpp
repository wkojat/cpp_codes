/*english
program determines design compressive strength of a concrete class chosen by user;
...
(concrete's design compressive strength is one of parameters used in calculations for civil engineering projects);
*/
...
2.  user chosen concrete class is assigned to a string object
3.  STL specific function 'find' searches for that key in the map and returns an iterator to the specific element
...
5.  if the key was found, corresponding mapped value is assigned to determined_concrete_strength variable
